...
Buffer.from("aGVsbG8<kbd>=</kbd>", "base64").toString("utf8")
```
...
encoded <kbd>=</kbd> base64.b64encode(b"hello")
decoded <kbd>=</kbd> base64.b64decode(encoded)
```
